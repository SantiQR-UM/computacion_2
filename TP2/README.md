...
- [ ] Sistema de cola con task IDs (Bonus Track opción 1)
- [ ] Rate limiting por dominio (Bonus Track opción 2)
- [ ] Caché con Redis (Bonus Track opción 2)
- [ ] Análisis avanzado: detección de tecnologías, SEO (Bonus Track opción 3)
- [ ] Soporte para autenticación en páginas
...
Trabajo Práctico 2 - Computación II

**Fecha de entrega**: 14/11/2025

## Licencia

Este proyecto es material educativo para el curso de Computación II.
